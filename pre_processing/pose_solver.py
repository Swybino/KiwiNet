...
class PoseEstimator:
    ...
    def _get_full_model_points(self, filename='data/model.txt'):
    ...
    def solve_pose(self, image_points):
        ...
        print(image_points.shape, self.model_points_68.shape)
        (_, rotation_vector, translation_vector) = cv2.solvePnP(
            np.array(self.model_points), np.array(image_points, dtype="double"), self.camera_matrix, self.dist_coeefs, flags=cv2.SOLVEPNP_ITERATIVE)
        print("------")
